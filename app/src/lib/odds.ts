/**
 * Payout and odds utility functions.
 * All odds are in American format (e.g. -110, +150).
 */
...
/**
 * Calculate the payout for a winning bet (stake + profit).
 * E.g. $100 at -110 → $190.91 (rounded to nearest integer credit)
 */
